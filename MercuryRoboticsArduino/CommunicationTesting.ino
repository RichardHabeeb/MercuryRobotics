...
CommunicationTesting::CommunicationTesting()
{
	...
	test[6].arm_angle_deg = 1;
	test[6].iris_angle_deg = 1;
	...
	test[10].arm_angle_deg = 1;
	test[10].iris_angle_deg = 1;
